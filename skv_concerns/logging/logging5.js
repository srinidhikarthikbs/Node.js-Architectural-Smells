...
by Josh Holbrook jesusabdullah on Friday, Aug 26 2011
articlesintermediatehow-to-log
...
Winston is a multi-transport, asynchronous logging library for node.js. It is conceptually similar to our custom logger, but comes with a wide variety of useful features and functionality baked in. In addition, winston is battle-hardened by internal use at Nodejitsu!
...
Winston also supports logging to Riak, CouchDB, MongoDB and even Loggly. The logger.warn call we used before also put the same message into each database, according to the options we gave to each transport.

For further information, please see the thorough documentation for Winston..
